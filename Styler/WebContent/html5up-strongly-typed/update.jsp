...
<tbody>
	<tr>
		<td><input type="text" class="form-control" placeholder="제목" name="title" value="<%= list.get(COMM_NUM).getTitle() %>" maxlength="50"></td>
	</tr>
	<tr>
		<td><textarea class="form-control" placeholder="내용을 입력하세요" name="content" value="<%= list.get(COMM_NUM).getContent()%>" maxlength="2048" style="height: 350px;"></textarea></td>
	</tr>
</tbody>
</table>
